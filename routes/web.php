...
Route::get(uri: '/penerbit', action: [PenerbitController::class, 'index'])->name(name: 'penerbitAdmin');
...
Route::post(uri: '/tambahpenerbit', action: [PenerbitController::class, 'tambah_penerbitAdmin'])->name(name: 'tambahpenerbit');

Route::get('/updatepenerbit/{penerbit_id}', [PenerbitController::class, 'edit'])->name('update_penerbit');
Route::post('/updatepenerbit/{penerbit_id}', [PenerbitController::class, 'update'])->name('update_penerbit_action');
